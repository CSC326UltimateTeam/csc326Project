...
def searchKeyWord(keyword, wholeString):
    ...
    if not result:
        ...
        urlHtml, resultNumber = createUrls(result)
    print urlHtml
...
def createUrl(title,url,description):
    ...
    urlHtml =  '<div class="" style="margin-left:10%; margin-top:1.5%">' + '<p><a href=" ' + url +' " style="color: #1C1BA8; font-size: 18px;">'+title+'</a></p>' +'<p style="margin-top:-0.8%;font-size:14px; "><a href="#" style=" color:green;">'+url+'</a></p>'+'<p style="margin-top:-1%; font-size:13px; width:45%">'+description+'</p><p></p> </div>'
    return urlHtml
